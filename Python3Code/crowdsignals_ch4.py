...
DATASET_FNAME = 'gestures_feat_engi_output.csv'
RESULT_FNAME = 'chapter4_gestures_feat_engi_output.csv'
...
def main():
    ...
    milliseconds_per_instance = (dataset.index[1] - dataset.index[0]).microseconds //10000
    ...
    if FLAGS.mode == 'frequency':
        ...
        print('fs ',fs, "::", 'ws ',ws)
        dataset = FreqAbs.abstract_frequency(dataset, ['mag_x'], ws, fs)
        # Spectral analysis.
        DataViz.plot_dataset(dataset, ['mag_x_max_freq', 'mag_x_freq_weighted', 'mag_x_pse', 'label'], ['like', 'like', 'like', 'like'], ['line', 'line', 'line','points'])
    ...
    if FLAGS.mode == 'final':
        ...
        DataViz.plot_dataset(dataset, ['acc_x', 'gyr_x', 'mag_x', 'gfc_x','inc_x','label'], ['like', 'like', 'like', 'like', 'like', 'like'], ['line','line', 'line', 'line', 'line', 'points'])
